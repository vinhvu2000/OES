...
fwrite($open, "[$now]: admin truy cập tab lớp\n");
fclose($open);
?>
<!DOCTYPE html>
<html>
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="categories.php" class="waves-effect waves-button"><span
                                        ...
                                        <div role="tabpanel">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab"
                                                        data-toggle="tab">Lớp</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab"
                                                        data-toggle="tab">Thêm lớp</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                    <div class="table-responsive">
                                                        ...
                                                        $sql = "SELECT loptinchi.*, monhoc.tenmh FROM loptinchi INNER JOIN monhoc ON loptinchi.mamh = monhoc.mamh";
                                        ...
                                        <tbody>';
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                if ($trangthai == "1") {
                                                                    ...
                                                                    $stl = '<a href="pages/make_ct_in.php?id=' . $row['maltc'] . '">Hủy kích hoạt</a>';
                                                                } else {
                                                                    $st = '<p class="text-danger">Không hoạt động</p>';
                                                                    $stl = '<a href="pages/make_ct_ac.php?id=' . $row['maltc'] . '">Kích hoạt</a>';
                                                                }
                                                                print '
										       <tr>
												<td>' . $row['maltc'] . '</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li><a href="view-student-in-class.php?cid=' . $row['maltc'] . '">Danh sách lớp</a></li>
                                                    <li>' . $stl . '</li>
                                                    <li><a'; ?> onclick = "return
                                                        confirm('Bạn có chắc chắn muốn xóa lớp <?php echo $row['maltc']; ?>
                                                        không ?')" <?php print ' href="pages/drop_ct.php?id=' . $row['maltc'] . '">Xóa lớp tín chí</a></li>
                                                </ul>
                                            </td>
                                            </tr>';
                                                            }
                                                            ...
                                                            print '
												<div class="alert alert-info" role="alert">Không tìm thấy dữ liệu.</div>';
                                                        }
                                                                                                                                                            $conn->close();
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab6">
                                                    <form action="pages/add_category.php" method="POST">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="VD:01"
                                                                name="stt" required autocomplete="off"><br>
                                                            <label for="exampleInputEmail1">Lịch học</label>
                                                            <input type="text" class="form-control"
                                                                placeholder="VD:Thứ 2(1-2)" name="lichhoc" required
                                                                autocomplete="off">
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Chọn môn học</label>
                                                            <select class="form-control" name="tenmh" required>
...
if (mysqli_query($conn, $sql2)) {
                                                                ...
                                                                if ($result->num_rows > 0) {
                                                                    while ($row = $result->fetch_assoc()) {
                                                                        print '<option value="' . $row['tenmh'] . '">' . $row['tenmh'] . '</option>';
                                                                    }
                                                                } else {
                                                                }
