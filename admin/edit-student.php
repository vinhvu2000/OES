...
<head>
    <title>OES | Sửa thông tin sinh viên</title>
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Sửa thông tin sinh viên - <?php echo "$hotendem"; ?> <?php echo "$ten"; ?>
                </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                                        ...
                                        <form action="pages/update_student.php" method="POST">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly
                                                    value="<?php echo "$masv"; ?>"
                                                    class="form-control" placeholder="Nhập mã sinh viên" name="masv"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    value="<?php echo "$hotendem"; ?>"
                                                    class="form-control" placeholder="Nhập họ và tên đệm"
                                                    name="hotendem" required autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Nam</label>
                                                <input type="radio" <?php if ($gioitinh == "Nam") {
    print ' checked ';
} ?> name="gioitinh"
                                                value="Male" required>
                                                <label for="exampleInputEmail1">Nữ</label>
                                                <input type="radio" <?php if ($gioitinhr == "Nữ") {
    print ' checked ';
} ?> name="gioitinh"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email"
                                                    ...
                                                    class="form-control" placeholder="Nhập địa chỉ email" name="email"
                                                    required autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    value="<?php echo "$sdt"; ?>"
                                                    class="form-control" placeholder="Nhập số điện thoại" name="sdt"
                                                    required autocomplete="off">
                                            </div>
                                            <div class="form-group">
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        while ($row = $result->fetch_assoc()) {
                                                            if ($makhoa == $row['makhoa']) {
                                                                print '<option selected value="' . $row['makhoa'] . '">' . $row['tenkhoa'] . '</option>';
                                                            } else {
                                                                print '<option value="' . $row['makhoa'] . '">' . $row['tenkhoa'] . '</option>';
                                                            }
                                                        }
                                                    } else {
                                                    }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input
                                                    ...
                                                    type="text" class="form-control date-picker" name="ngaysinh"
                                                    required autocomplete="off" placeholder="Chọn ngày sinh">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Địa chỉ</label>
                                                <textarea style="resize: none;" rows="4" class="form-control"
                                                    placeholder="Nhập địa chỉ" name="diachi" required
                                                    autocomplete="off"><?php echo "$diachi"; ?></textarea>
                                            </div>
