    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Kết quả tóm tắt - <?php echo "$exname"; ?>
                </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
        ...
        window.onload = function() {
            ...
            var chart = new CanvasJS.Chart("chartContainer", {
                ...
                data: [{
                    ...
                    dataPoints: [{
                            y: <?php echo "$stdpass"; ?> ,
                            label: "Số sinh viên vượt qua"
                        },
                        {
                            y: <?php echo "$stdfail"; ?> ,
                            label: "Số sinh viên trượt"
                        },
