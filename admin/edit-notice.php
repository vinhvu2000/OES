    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Sửa thông báo - <?php echo "$tieude"; ?>
                </h3>
                                        ...
                                        <form action="pages/update_notice.php" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    class="form-control" placeholder="Nhập tiêu đề" name="tieude"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea style="resize: none;" rows="4" class="form-control"
                                                    placeholder="Nhập nội dung" name="noidung" required
                                                    autocomplete="off"><?php echo "$noidung"; ?></textarea>
                                            </div>
