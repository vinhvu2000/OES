...
fwrite($open, "[$now]: admin truy cập tab sinh viên\n");
fclose($open);
?>
<!DOCTYPE html>
<html>
...
<head>
    <title>OES | Quản lí sinh viên</title>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                    <div class="table-responsive">
                                                        ...
                                                        $sql = "SELECT sinhvien.*,taikhoan.trangthai FROM sinhvien INNER JOIN taikhoan ON sinhvien.masv = taikhoan.username WHERE taikhoan.vaitro = 'student'";
                                                    ...
                                                    <form action="pages/add_student.php" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control date-picker"
                                                                name="ngaysinh" required autocomplete="off"
                                                                placeholder="Chọn ngày sinh">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Nam</label>
                                                            <input type="radio" name="gioitinh" value="Male" required>
                                                            <label for="exampleInputEmail1">Nữ</label>
                                                            <input type="radio" name="gioitinh" value="Female" required>
                                                        </div>
                                                        <div class="form-group">
 ...
 if (mysqli_query($conn, $sql2)) {
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea style="resize: none;" rows="4"
                                                                ...
                                                                name="diachi" required autocomplete="off"></textarea>
                                                        </div>
