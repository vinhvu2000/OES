...
fwrite($open, "[$now]: admin truy cập tab thông báo\n");
fclose($open);
?>
<!DOCTYPE html>
<html>
...
<head>
    <title>OES | Quản lí thông báo</title>
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="notice.php" class="waves-effect waves-button"><span
                                        ...
                                        <div role="tabpanel">
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation"><a href="#tab6" role="tab"
                                                        data-toggle="tab">Thêm thông báo</a></li>
                                            </ul>
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                    <div class="table-responsive">
                                                        ...
                                                        $sql = "SELECT thongbao.*, monhoc.tenmh FROM thongbao INNER JOIN monhoc ON thongbao.mamh = monhoc.mamh";
                                        ...
                                        <tbody>';
										       ...
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
												    <li><a href="edit-notice.php?id=' . $row['matb'] . '">Sửa thông báo</a></li>
                                                    <li><a'; ?> onclick = "return
                                                        confirm('Bạn có chắc chắn muốn xóa thông báo <?php echo $row['tieude']; ?>
                                                        không?')" <?php print ' href="pages/drop_not.php?id=' . $row['matb'] . '">Xóa thông báo</a></li>
                                                </ul>
                                            </div></td>
     ...
     echo "error: " . $sql2 . "<br>" . mysqli_error($conn);
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Nhập tiêu đề" name="tieude" required
                                                                autocomplete="off">
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea style="resize: none;" rows="4"
                                                                ...
                                                                name="noidung" required autocomplete="off"></textarea>
                                                        </div>
