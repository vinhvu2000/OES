...
fwrite($open, "[$now]: admin truy cập tab kết quả\n");
fclose($open);
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <title>OES | Quản lí kết quả</title>
                                        ...
                                        <tbody>';
										       ...
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
													<li><a href="view-results.php?eid=' . $row['mabkt'] . '">Xem kết quả</a></li>
									                <li><a href="summary.php?eid=' . $row['mabkt'] . '">Tóm tắt</a></li>
                                                </ul>
                                            </div></td>
                                            </tr>';
                                                }
