...
if (isset($_GET['cid'])) {
    ...
    $maltc = mysqli_real_escape_string($conn, $_GET['cid']);
    $username = isset($_SESSION['user'])?$_SESSION['user']:'Unknow';
    $time_start = microtime(true);

    $sql = "SELECT * FROM loptinchi INNER JOIN monhoc ON loptinchi.mamh = monhoc.mamh WHERE maltc = '$maltc'";
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Thông tin lớp - <?php echo "$tenmh - $lichhoc "; ?>
                </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                                        ...
                                        <div role="tabpanel">
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation"><a href="#tab6" role="tab"
                                                        data-toggle="tab">Thêm sinh viên</a></li>
                                            </ul>
...
$time_start = microtime(true);
                                                        ...
                                                        $sql = "SELECT * FROM dangki INNER JOIN sinhvien ON dangki.masv = sinhvien.masv WHERE dangki.maltc='$maltc'";
                                                        $result = $conn->query($sql);
                                                        if ($result->num_rows > 0) {
                                                            print '
                                        ...
                                        <tbody>';
                                               ...
                                               <td>' . $row['makhoa'] . '</td>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a'; ?> onclick = "return
                                                        confirm('Bạn có chắc chắn muốn xóa sinh viên <?php echo $row['hotendem'] . $row['ten']; ?>
                                                        không?')" <?php print ' href="pages/drop_sd_fc.php?id=' . $row['masv'] . '&cid='.$maltc.'">Xóa sinh viên khỏi lớp</a></li>
                                                </ul>
                                            </div></td>
                                        ...
                                        Không tìm thấy dữ liệu.
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab6">
                                                    <form action="pages/add_student_to_class.php" method="POST">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Mã sinh viên</label>
                                                            <input type="text" class="form-control"
                                                                placeholder="Nhập mã sinh viên" name="masv" required
                                                                autocomplete="off">
                                                        </div>
                                                        <input type="hidden"
                                                            value="<?php echo $maltc ?>"
                                                            name="maltc">
