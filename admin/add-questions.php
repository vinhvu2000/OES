    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Thêm câu hỏi cho - <?php echo "$exam_name"; ?>
                </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                                        ...
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab"
                                                        data-toggle="tab">Chọn đáp án đúng</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab"
                                                        data-toggle="tab">Điền vào chỗ trống</a></li>
                                            </ul>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Đáp án
                                                                                A</label>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Nhập đáp án A" name="opt1"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Đáp án
                                                                                B</label>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Nhập đáp án B" name="opt2"
                                                                                required autocomplete="off">
                                                                        </div>
                                                                    </td>
                                                                    <td><input type="radio" name="answer"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Đáp án
                                                                                C</label>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Nhập đáp án C" name="opt3"
                                                                                required autocomplete="off">
                                                                        </div>
                                                                    </td>
                                                                    <td><input type="radio" name="answer"
                                                                    ...
                                                                    <td>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputEmail1">Đáp án
                                                                                D</label>
                                                                            <input type="text" class="form-control"
                                                                                placeholder="Nhập đáp án D name=" opt4"
                                                                                required autocomplete="off">
                                                                        </div>
                                                                    </td>
                                                                    <td><input type="radio" name="answer"
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab6">
                                                    <form action="pages/add_question.php?type=fib" method="POST">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Nhập đáp án" name="answer" required
                                                                autocomplete="off">
                                                        </div>
                                                        <input type="hidden" name="exam_id"
                                                            value="<?php echo "$exam_id"; ?>">
