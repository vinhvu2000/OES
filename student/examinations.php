        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span>
                            <p>Bài kiểm tra</p>
                        </a></li>
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    $maltc = $row['maltc'];
                                                    $sql1 = "SELECT baikt.*,monhoc.tenmh FROM baikt INNER JOIN monhoc ON baikt.mamh = monhoc.mamh WHERE baikt.maltc LIKE '%$maltc%'";
                                        ...
                                        <tbody>';
                                                        ...
                                                        while ($row1 = $result1->fetch_assoc()) {
                                                            $status = $row1['trangthai'];
                                                            if ($status == "1") {
                                                                $st = '<p class="text-success">Đang hoạt động</p>';
                                                                $stl = '<a class="btn btn-success" href="take-assessment.php?id=' . $row1['mabkt'] . '">Làm bài</a>';
                                                            } else {
                                                                $st = '<p class="text-danger">Không hoạt động</p>';
                                                                $stl = '<a class="btn btn-danger disabled" href="#">Làm bài</a>';
                                                            }
                                                            print '
										       <tr>
                                               <td>' . $row1['tenmh'] . '</td>
