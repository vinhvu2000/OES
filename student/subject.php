        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="subject.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-file"></span>
                            <p>Môn học</p>
                        </a></li>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            ...
                                            $sql = "SELECT monhoc.*, TG.maltc,TG.lichhoc FROM monhoc INNER JOIN (SELECT loptinchi.* FROM dangki INNER JOIN loptinchi ON dangki.maltc = loptinchi.maltc WHERE masv = '$masv') as TG ON monhoc.mamh = tg.mamh";
